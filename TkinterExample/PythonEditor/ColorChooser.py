...
class ColorChooser(tk.Toplevel):
    def __init__(self, master, **kwargs):
        ...
        #buttons
        foreground_color_chooser = ttk.Button(window_foreground_frame, text='Change Foreground color',
                                              width=26, style='editor.TButton',
                                              command=lambda sv=self.chosen_foreground_color: self.set_color(sv))
        background_color_chooser = ttk.Button(window_background_frame, text='Change Background color',
                                              width=26, style='editor.TButton',
