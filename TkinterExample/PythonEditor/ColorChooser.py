...
import tkinter.colorchooser as askcolor
...
class ColorChooser(tk.Toplevel):
    def __init__(self, master, **kwargs):
        ...
        #buttons
        self.foreground_color_chooser = ttk.Button(window_foreground_frame, text='Change Foreground color',
                                              width=26, style='editor.TButton',
                                              command=lambda sv=self.chosen_foreground_color: self.set_color(sv))
        self.background_color_chooser = ttk.Button(window_background_frame, text='Change Background color',
                                              width=26, style='editor.TButton',
                                              command=lambda sv=self.chosen_background_color: self.set_color(sv))
        self.text_foreground_color_chooser = ttk.Button(text_foreground_frame, text='Change Text Foreground color',
                                              width=26, style='editor.TButton',
                                              command=lambda sv=self.chosen_text_foreground_color: self.set_color(sv))
        self.text_background_color_chooser = ttk.Button(text_background_frame, text='Change Text Background color',
                                              width=26, style='editor.TButton',
        ...
        self.foreground_color_chooser.pack(side=tk.LEFT)
        ...
        self.background_color_chooser.pack(side=tk.LEFT)
        ...
        self.text_foreground_color_chooser.pack(side=tk.LEFT)
        ...
        self.text_background_color_chooser.pack(side=tk.LEFT)
