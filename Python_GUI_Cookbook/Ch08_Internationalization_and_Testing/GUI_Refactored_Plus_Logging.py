...
from Python_GUI_Cookbook.Ch08_Internationalization_and_Testing.Logger import Logger, LogLevel
...
class OOP():
    def __init__(self):
        ...
        self.log = Logger(self, fullPath)
        self.log.setLoggingLevel(LogLevel.NORMAL)
        #create a queue
...
if __name__ == '__main__':
    #START GUI
    oop = OOP()
    # oop.logLevel = LogLevel.DEBUG
    oop.logLevel = LogLevel.MINIMUM
    oop.log_dateTime()
