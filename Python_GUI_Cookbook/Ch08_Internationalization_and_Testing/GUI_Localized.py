...
class OOP():
    ...
    def getDateTime(self):
        ...
        self.TZ.set(ny.strftime(fmtStrZone))
        self.win.update()
    ...
    def create_widgets(self):
        ...
        #adding a TZ butotns
        self.allTZs = ttk.Button(self.tab1, text=self.i18n.timeZones,command=self.allTimeZones)
        self.allTZs.grid(column=0, row=9, sticky='WE')
        self.localTZ = ttk.Button(self.tab1, text=self.i18n.localZone, command=self.localTimeZone)
        self.localTZ.grid(column=0, row=10, sticky='WE')
        self.nyTZ = ttk.Button(self.tab1, text='NY Time', command=self.getDateTime)
